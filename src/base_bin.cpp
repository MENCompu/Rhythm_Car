...
Intern void GetDLLPaths(String binDir, String *DLLPath, String *tempDLLPath) {
...
Export void RC_Main(void) {
    ...
    GetDLLPaths(binDir, &DLLPath, &tempDLLPath);
    ...
    s32x2 winDims;
    stateHR.Init1(&window, &instance, &winDims);
    (void)VK_Init(window, instance, winDims);
    stateHR.Init2(binDir);
    ...
    // NOTE(JENH): Try to cleanup this as late as possible.
    VK_Cleanup();
}
#else
